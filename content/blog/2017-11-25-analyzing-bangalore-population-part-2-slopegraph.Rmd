...
This is part 2 of of the population analysis of Bangalore using R. In [part 1 we explored how to make animated choropleth on timeseries populataion data](https://www.shyamvalsan.com/blog/analyzing-bangalore-population-animated-choropleth-timeseries/). While the previous visualization we did was geographical in nature, this time we’re going to visualize Bangalore population data using a slopegraph. Slopegraphs help paint a before and after story by providing insights into ranking, magnitude and changes over time.
